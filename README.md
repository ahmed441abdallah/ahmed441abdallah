...
### Full Stack Developer | MERN & Next.js Specialist | Building Scalable Web Apps for the UAE Tech Market

<img src="https://readme-typing-svg.demolab.com?font=Poppins&size=20&duration=3000&pause=1000&color=4F46E5&center=true&vCenter=true&width=600&lines=Full+Stack+Developer+(MERN);React+%7C+Node.js+%7C+Next.js;Building+Premium+Digital+Experiences" alt="Typing SVG" />
...
- 🚀 Full Stack Developer focused on building **scalable, production-ready web applications** using the MERN stack and Next.js.
- 🎯 Currently targeting **Full Stack Developer roles in the UAE**, with a strong focus on clean architecture and maintainable code.
- 🎨 Passionate about crafting **premium, intuitive user experiences** — blending solid backend logic with polished, responsive UI.
- 🔧 Comfortable owning a project end-to-end: from REST API design and database modeling to deployment and performance optimization.
